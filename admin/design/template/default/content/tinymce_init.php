<script type="text/javascript" src="/media/js/tiny_mce/plugins/smimage/smplugins.js"></script>
...
<script>
  tinyMCE.init({
        ...
        content_css :"<?=Request::$design->root?>/css/tiny.css",
        ...
        plugin_smexplorer_directory : "/media/update",
